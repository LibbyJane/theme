  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      fetchQuantityRules() {
        ...
        this.querySelector('.quantity__rules-cart js-loading-overlay__spinner')?.classList.remove('hidden');
        return fetch(`${this.dataset.url}?variant=${currentVariantId}&section_id=${this.dataset.section}`)
          ...
          .finally(() => this.querySelector('.quantity__rules-cart js-loading-overlay__spinner').classList.add('hidden'));
      }
...
//         this.querySelector('.js-quantity__rules-cart .js-loading-overlay').classList.remove('hidden');
...
//           })
//           .finally(() => {
//             this.querySelector('.js-quantity__rules-cart .js-loading-overlay').classList.add('hidden');
//           });
//       }
