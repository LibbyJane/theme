    ...
    customElements.define(
        ...
        class RecipientForm extends HTMLElement {
            constructor() {
                ...
                this.errorMessageList = this.errorMessageWrapper?.querySelector('.js-error-message-list');
                this.errorMessage = this.errorMessageWrapper?.querySelector('.js-error-message');
